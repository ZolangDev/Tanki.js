    ...
    var e = {
                ...
                class s {
                    ...
                    shellsTeleport = (e, t) => {
                        ...
                        if (o && (!0 === this.rocketTP.state || s.length !== e.salvoRocketsCount || this.rocketTP.timeout || (this.rocketTP.timeout = setTimeout((() => {
                            ...
                            }), 2e3)), i.P6.isBindPressed(a) && (this.rocketTP.state = !0), this.rocketTP.state)) {
                            if (this.rocketTP.timeout && (clearTimeout(this.rocketTP.timeout), this.rocketTP.timeout = void 0), this.rocketTP.state = !1, i.P6.match(o.position, "distance_")?.(i.Z_.lastSendState.position) > 1100)
                                for (const e of s) {
                                    const t = e.components.StrikerRocketComponent;
            ...
            487: (e, t, a) => {
                ...
                class s {
                    ...
                    openingAnimation = () => {
                        40 !== this.#I ? this.#I += 4 : this.#v = !1
                    };
                    closingAnimation = () => {
                        0 !== this.#I ? this.#I -= 4 : this.#v = !1, this.#v || this.hideMenu()
                    };
                    applyFilter = e => {
                        canvas.style.opacity = e / 40 * 1, root.style.filter = `blur(${.1*e}px) brightness(${1-e/100})`
                    };
                    animationTask = () => {
                        this.#v && requestAnimationFrame(this.animationTask), this.isOpen ? this.openingAnimation() : this.closingAnimation(), this.applyFilter(this.#I)
                    };
                    showMenu = () => {
